"""
Platform fee collection — 0.05% of every trade notional value.
...
Fee rate: 0.05%  (FEE_BPS = 5 basis points)
"""
...
FEE_BPS: float  = 5.0          # basis points  (5 bps = 0.05%)
FEE_RATE: float = FEE_BPS / 10_000   # 0.0005
